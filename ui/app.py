...
<style>
    ...
    .stChatInput textarea { background-color: #161B22 !important; color: #C9D1D9 !important; border-color: #30363D !important; }
    .stTextInput input { background-color: #161B22 !important; color: #C9D1D9 !important; border-color: #30363D !important; }
            ...
            if col1.button("Helpful", key=f"up_{i}"):
                ...
                try:
                    requests.post(f"{API_URL}/feedback", json={
                        "question": prev_q, "answer": msg["content"], "rating": 1
                    }, timeout=5)
                except Exception:
                    pass
...
if prompt := st.chat_input("Ask about your tech career..."):
    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            answer = "Error connecting to API. Make sure the API is running on port 8000."
        placeholder.empty()
        st.write(answer)
